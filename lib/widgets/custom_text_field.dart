              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(width: 1.w, color: borderColor ?? AppColors.lightGray)),
                  focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(borderRadius ?? 8.r),
                      borderSide: BorderSide(width: 1.w, color: isError ?? false ? AppColors.errorColor : AppColors.lightGray)),
                  errorBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(borderRadius ?? 8.r),
                      borderSide: BorderSide(width: 1.w, color: errorBorderColor ?? AppColors.lightGray)),
                  ...
                  disabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(borderRadius ?? 8.r),
                      borderSide: BorderSide(width: 1.w, color: borderColor ?? AppColors.primary)),
