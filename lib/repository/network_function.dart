...
loadingDialog() {
  ...
  Get.dialog(Center(child: LoadingAnimationWidget.inkDrop(color: Colors.amber, size: 50.sp)), barrierDismissible: false,useSafeArea: true,barrierColor: AppColors.grayBackground);
}
