...
import 'package:quizy/screens/settings_screen/restore_purchase_dailog.dart';
            ...
            GestureDetector(
              onTap: (){
                showDialog(
                  ...
                  builder: (context) => const RestorePurchaseDialog(),
                );
              },
              child: Container(
                padding: EdgeInsets.all(16.sp),
        ...
        child: Column(
          ...
          children: [
            ...
            LoadingAnimationWidget.inkDrop(
              color: Colors.amber, // Change to match exact color
              size: 50,
            ),
